...
export function WizardFlow({ open, onOpenChange, onComplete }: WizardFlowProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[96vw] max-w-[1500px] max-h-[94vh] sm:max-h-[92vh] overflow-y-auto bg-slate-950 text-slate-100 border-slate-800/80 p-4 sm:p-6 rounded-2xl shadow-2xl shadow-indigo-950/90 transition-all duration-200">
